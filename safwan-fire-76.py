...
def ua():
	...
	END = f"[FBAN/FB4A;FBAV/345.0.0.34.118;FBBV/332957647;FBDM/{{density={density},width={width},height={height}}};FBLC/en_GB;FBRV/334763932;FBCR/Robi;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/{fbdv};FBSV/11;FBOP/1;FBCA/arm64-v8a:;]"
	ua = 'Davik/2.1.0 (Linux; U; Android '+str(random.randrange(5,12))+'.0.1; '+str(fbdv)+' Build/'+str(build)+') '+END
	return ua
#__________________[ LOGO ]__________________#
logo=(f"""
 _____  ___  ______ _    _  ___   _   _ 
/  ___|/ _ \ |  ___| |  | |/ _ \ | \ | |
\ `--./ /_\ \| |_  | |  | / /_\ \|  \| |
 `--. \  _  ||  _| | |/\| |  _  || . ` |
/\__/ / | | || |   \  /\  / | | || |\  |
